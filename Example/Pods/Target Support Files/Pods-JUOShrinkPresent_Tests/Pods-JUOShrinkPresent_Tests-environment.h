...
// JUOShrinkPresent
#define COCOAPODS_POD_AVAILABLE_JUOShrinkPresent
#define COCOAPODS_VERSION_MAJOR_JUOShrinkPresent 0
#define COCOAPODS_VERSION_MINOR_JUOShrinkPresent 1
#define COCOAPODS_VERSION_PATCH_JUOShrinkPresent 0
